...
$yamashitaMenu = [
                    ...
                    { code: 16, item: "Karaage don (Fried chicken)", price: 150},
                    { code: 17, item: "Yakiniku don (Fried beef with special sauce)", price: 190},
                    { code: 18, item: "Shogayaki don (Ginger pork)", price: 190},
                    { code: 19, item: "Katsu don (Breaded pork with egg)", price: 210},
                    { code: 20, item: "Pork rice topping", price: 90},
                    { code: 21, item: "Spicy pork rice topping", price: 110},
                    { code: 22, item: "Chahan (Japanese fried rice)", price: 160},
                    { code: 23, item: "California mango rolls", price: 160},
                    { code: 24, item: "Salad maki", price: 150},
                    { code: 25, item: "Karaage rolls (Fried chicken)", price: 140},
                    { code: 26, item: "Onion salmon rolls", price: 170},
                    { code: 27, item: "Tekka maki (Tuna)", price: 150},
                    { code: 28, item: "Salmon maki", price: 150},
                    { code: 29, item: "Gyoza (Japanese dumpling 6 pcs)", price: 90},
                    { code: 30, item: "Karaage (Fried chicken 3 pcs)", price: 90},
                    { code: 31, item: "Shrimp Fries (with special sauce 4 pcs)", price: 140},
                    { code: 32, item: "Plain Japanese rice", price: 50},
                  ]
